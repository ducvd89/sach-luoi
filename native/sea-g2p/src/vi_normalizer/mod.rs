...
// Các thuộc tính của PyO3 chỉ gắn khi dựng bản cho Python. Bản cổng C dùng
// đúng struct và đúng hàm này, chỉ khác là không có lớp bọc Python.
...
impl Normalizer {
    ...
    // Chỉ có ở bản Python: cần kiểu Python<'_> để nhả GIL.
    #[cfg(feature = "python")]
